    ...
    public class IndexModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            Heroes = new List<Hero>
            {
                ...
                new Hero { Id = 9, Name = "Green Arrow (Oliver Queen)", Description = "Master archer. Powers: Archery, unrivaled aim, exceptional martial artist, inexhaustible wealth. Billionaire Oliver Queen uses both his wealth and his unmatched archery skills.", ImageUrl = "/images/greenarrow.jpg", DcProfileUrl = "https://www.dc.com/characters/green-arrow" }
            };
